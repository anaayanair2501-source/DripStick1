...
import { Sparkles, Heart, Award, ShieldCheck, Flame, Compass } from 'lucide-react';
...
export const OurStorySection: React.FC = () => {
  ...
  return (
    <section id="story" className="py-24 bg-[#FDF8F2] relative overflow-hidden border-t border-b border-[#4A2C2A]/10">
      {/* Decorative Warm Ambient Elements */}
      <div className="absolute -top-24 -left-24 w-80 h-80 bg-[#D2916C]/10 rounded-full blur-3xl pointer-events-none" />
      <div className="absolute -bottom-24 -right-24 w-96 h-96 bg-[#4A2C2A]/5 rounded-full blur-3xl pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-8 lg:px-12">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h2 className="font-brand font-black text-4xl sm:text-5xl lg:text-6xl text-[#4A2C2A] tracking-tight mb-4">
            ...
            <span className="text-[#D2916C] italic">make waffles more fun.</span>”
          </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center mb-16">
          ...
          <div className="lg:col-span-6 relative">
            <div className="relative z-10 rounded-3xl overflow-hidden shadow-2xl border-4 border-white">
              ...
              <div className="absolute bottom-4 left-4 right-4 text-white">
                <p className="text-[10px] font-bold uppercase tracking-widest text-[#D2916C]">Street-Style Luxury</p>
            ...
            <div className="hidden sm:block absolute -bottom-10 -right-6 z-20 w-52 sm:w-60 rounded-2xl overflow-hidden shadow-2xl border-4 border-white bg-[#4A2C2A] animate-float">
              ...
              <div className="p-3 bg-white">
                ...
                <p className="text-[10px] text-[#D2916C] font-semibold">Dipped live to order</p>
              </div>
            </div>

            {/* Floating Mini Badge */}
            <div className="absolute -top-4 -left-4 z-20 bg-[#4A2C2A] text-[#FDF8F2] p-4 rounded-2xl shadow-xl flex items-center gap-3">
              <div className="w-9 h-9 rounded-xl bg-[#D2916C] flex items-center justify-center text-xl text-white font-black">
                ★
              </div>
              <div>
                <p className="text-xs font-bold uppercase text-[#D2916C]">Pearl Sugar Infused</p>
                <p className="text-[11px] text-[#FDF8F2]/70">Authentic Liège Method</p>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-6 flex flex-col items-start">
            ...
            <div className="flex items-center gap-2 p-1.5 rounded-full bg-white border border-[#4A2C2A]/15 mb-8 shadow-xs">
              <button
            ...
            {activeTab === 'craft' && (
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  <div className="w-10 h-10 rounded-xl bg-white border border-[#4A2C2A]/15 flex items-center justify-center shrink-0">
                    <Flame className="w-5 h-5 text-[#D2916C]" />
                  </div>
                  <div>
                ...
                <div className="flex items-start gap-4">
                  <div className="w-10 h-10 rounded-xl bg-white border border-[#4A2C2A]/15 flex items-center justify-center shrink-0">
                    <Award className="w-5 h-5 text-[#D2916C]" />
                  </div>
                  <div>
                    <h3 className="font-display font-extrabold text-xl text-[#4A2C2A] mb-1">
            ...
            {activeTab === 'dip' && (
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  <div className="w-10 h-10 rounded-xl bg-white border border-[#4A2C2A]/15 flex items-center justify-center shrink-0">
                    <ShieldCheck className="w-5 h-5 text-[#D2916C]" />
                  </div>
                  <div>
                    <h3 className="font-display font-extrabold text-xl text-[#4A2C2A] mb-1">
                ...
                <div className="flex items-start gap-4">
                  <div className="w-10 h-10 rounded-xl bg-white border border-[#4A2C2A]/15 flex items-center justify-center shrink-0">
                    <Compass className="w-5 h-5 text-[#D2916C]" />
                  </div>
                  <div>
                    <h3 className="font-display font-extrabold text-xl text-[#4A2C2A] mb-1">
            ...
            {activeTab === 'vibe' && (
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  <div className="w-10 h-10 rounded-xl bg-white border border-[#4A2C2A]/15 flex items-center justify-center shrink-0">
                    <Heart className="w-5 h-5 text-[#D2916C]" />
                  </div>
                  <div>
                    <h3 className="font-display font-extrabold text-xl text-[#4A2C2A] mb-1">
                ...
                <div className="flex items-start gap-4">
                  <div className="w-10 h-10 rounded-xl bg-white border border-[#4A2C2A]/15 flex items-center justify-center shrink-0">
                    <Sparkles className="w-5 h-5 text-[#D2916C]" />
                  </div>
                  <div>
                    <h3 className="font-display font-extrabold text-xl text-[#4A2C2A] mb-1">
            ...
            {/* Bottom Quote Badge */}
            <div className="mt-8 p-4 rounded-2xl bg-white border border-[#4A2C2A]/10 flex items-center gap-3 w-full shadow-xs">
              <span className="text-2xl">✨</span>
              <p className="text-xs text-[#4A2C2A]/80 italic font-medium">
